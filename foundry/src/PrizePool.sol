...
contract PrizePool {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
  ...
  mapping(uint256 => uint256) public noOfStakersPerGameId;
  mapping(uint256 => mapping (uint256 => UserInfo)) public gameIdToUserInfoPerIndex;
  mapping(uint256 => uint256) public totalAmountStaked;
  mapping(uint256 => bool) public completedGameId;
  

function versusStake(bool _erc20, uint256 _gameId, uint256 _amountStaked, address token, uint256 _fid) public payable {
   
   if (_erc20) {
      // deposit(_amount, _token);
   } else {
      require(_amountStaked == msg.value, "amountStaked differs msg.value");
   }
   
   
   gameIdToUserInfoPerIndex[_gameId][noOfStakersPerGameId[_gameId]] = UserInfo({fid: _fid, amountStaked: _amountStaked, token: token});
   noOfStakersPerGameId[_gameId] += 1;
   totalAmountStaked[_gameId] += _amountStaked; 
}
    ...
    function deposit(uint _amount, address _token) public payable {
      ...
      //   if(!transferred) revert FailedDeposit(msg.sender, _amount, _token);
      //   else emit Received(msg.sender, _amount);

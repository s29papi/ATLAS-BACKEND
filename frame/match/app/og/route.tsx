  ...
  return (
    <div style={{ position: 'relative', display: 'flex' }}>
      <img 
        ...
        alt="Your Image" 
      />
      <div style={{ display: 'flex', position: 'absolute', top: '65%', left: '50%', transform: 'translate(-50%, -50%)', textAlign: 'center', color: '#66757F', fontSize: '72px', fontWeight: 'bold' }}> 
